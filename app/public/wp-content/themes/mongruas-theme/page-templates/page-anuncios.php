<?php
/**
 * Template Name: Página Anuncios Completa
 * Template Post Type: page
 * 
 * Página completa de anuncios con certificados, cursos y catálogos
 *
 * @package Mongruas
 * @since 1.0.0
 */
                        ...
                        <?php if ($cursos && count($cursos) > 0) : ?>
                            ...
                            <div class="upcoming-course-card">
                                ...
                                <div class="course-actions">
                                    ...
                                    <a href="<?php echo home_url('/#contact'); ?>" class="btn btn-outline">Reservar Plaza</a>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        <?php else : ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateCarousel();
    console.log('✅ Carrusel de próximos cursos cargado:', cards.length, 'cursos');
});
</script>
